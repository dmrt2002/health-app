      ...
      <div class="container relative mx-auto">
        <div class="items-center flex flex-wrap">
          <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
            <div>
              <!-- <h1 class="text-white font-semibold text-5xl py-6">
                Your story <span >starts</span> with us.
              </h1> -->
              <!-- Custom Title starts here -->
    <h3 class="mx-auto  max-w-4xl font-display text-6xl font-medium tracking-tight text-white sm:text-6xl pb-4">
                                Empowering
              ...
              <a
                href="#_"
                class="relative inline-flex items-center justify-center px-6 py-3 m-4 overflow-hidden font-bold text-white rounded-md shadow-2xl group"
              >
                <span
...
<script>
// import img from '../../assets/banner-1-img.png'
export default {
  name: "HeroSection",
};
</script>
